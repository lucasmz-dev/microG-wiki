...
| [Discord][discord] | `6.5.6`         | `0.2.4-111-gf1cdb48` | LineageOS 14.1 | OnePlus 3T | Does not register for push notifications |:heavy_check_mark: fixed with at least 0.2.10.200475, probably earlier (see issue)| :heavy_check_mark: | [540][discord-issue] |
| [eBay][ebay] | `6.4.0.12` | `0.2.11.202414` | Havoc 3 (Android 10)| | Does not load any data (fixed) | Fixed, possibly with microG 0.2.11 | :heavy_check_mark: | [885](https://github.com/microg/android_packages_apps_GmsCore/issues/885), [1007](https://github.com/microg/android_packages_apps_GmsCore/issues/1007)
| [eBay Kleinanzeigen][ebaykleinanzeigen] | `11.8.0` - and all versions after | `0.2.11.202414` | LineageOS for microG 17.1 | Xiaomi Redmi Note 5 | Freezes and does not register for push notifications | Use app version [11.7.0](https://www.apkmirror.com/apk/ebay-classifieds-group/ebay-kleinanzeigen-for-germany/ebay-kleinanzeigen-for-germany-11-7-0-release/) or below | :heavy_check_mark: | [1151](https://github.com/microg/android_packages_apps_GmsCore/issues/1151) |
